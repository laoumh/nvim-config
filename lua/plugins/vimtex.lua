...
-- Configura which-key conforme wiki
-- https://github.com/lervag/vimtex/wiki/which%E2%80%90key.nvim-support
local config_whichkey = function(buffer)
